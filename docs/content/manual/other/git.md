...
* Для работы сервера "1С Предриятия" используется Windows-сервер с установленным Git;
...
* В виду особенносте работы Git функции библиотеки вызываются последовательно в одной очереди для исключения
...
2. Создать настройку репозитория Git в меню: *Интеграция с Git* &#8594; *Git: Настройки репозиториев*.
   ...
   * *Путь к репозиторию* - сетевой путь к удалённому репозиторию без указания протокола соединения,
        например *github.com/aagorlan/onec-esb-kb*.
...
>Вызов функции: *Git_ОбщегоНазначения.ИнициализацияПодключенияКРепозиторию(Настройка, ИмяВетки);*
>
>* *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
>* *ИмяВетки* - Строка;
>
...
> Вызов функции: *Git_ОбщегоНазначения.СтатусФайлов(Настройка, ТолькоПроверитьИзменения);*
>
> * *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
...
>Вызов функции: *Git_ОбщегоНазначения.СоздатьОтправитьКоммит(Настройка, СообщениеКоммита);*
>
>* *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
...
>Вызов функции: *Git_ОбщегоНазначения.Перебазировать(Настройка, ИмяВетки, НоваяБаза);*
>
>* *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
>* *ИмяВетки* - Строка;
...
>Вызов функции: *Git_ОбщегоНазначения.СлитьВетки(Настройка, ИмяЦелевойВетки, ИмяВливаемойВетки);*
>
>* *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
...
>Вызов функции: *Git_ОбщегоНазначения.УдалитьВетку(Настройка, ИмяВетки, ВУдаленномРепозитории);*
>
>* *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
>* *ИмяВетки* - Строка;
...
>Вызов функции: *Git_ОбщегоНазначения.ПереключитьсяНаВеткуКоммит(Настройка, ИмяВеткиИдКоммита);*
>
>* *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
...
>Вызов функции: *Git_ОбщегоНазначения.ОтправитьВУдаленныйРепозиторий(Настройка, ПараметрыКоманды);*
>
>* *Настройка* - элемент справочника "Git_НастройкиРепозиториев";
